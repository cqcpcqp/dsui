...
<template>
  <ds-flex :direction="'column'" align="normal">
    <ds-flex class="head" :justify="'space-between'" :align="'center'">
      <ds-flex :align="'center'" :gap="'20px'">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="16" height="16" viewBox="0 0 200 200"
          preserveAspectRatio="xMidYMid meet">
          <g transform="translate(0.000000,185.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
            <path
            ...
            <path d="M859 1448 c-25 -20 -30 -46 -13 -63 21 -21 38 -19 71 9 23 20 26 28 17 43 -14 22 -54 28 -75 11z" />
          </g>
        </svg>
        <span :class="{ active: selectedMenu === 'guide' }" class="menu" @click="selectedMenu = 'guide'">Guide</span>
        <span :class="{ active: selectedMenu === 'component' }" class="menu"
          @click="selectedMenu = 'component'">Component</span>
        <span :class="{ active: selectedMenu === 'headless' }" class="menu"
          @click="selectedMenu = 'headless'">Headless</span>
      </ds-flex>
      <span>Github</span>
    </ds-flex>
